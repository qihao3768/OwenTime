...
open class ProductBannerAdapter(var context:Context,var mData: List<String>?) :
    ...
    inner class VideoHolder(var binding: LayoutVideoItemBinding):RecyclerView.ViewHolder(binding.root){

    }

    inner class ImageHolder(var binding: LayoutImageItemBinding):RecyclerView.ViewHolder(binding.root){
